...
function animateText() {
    ...
    ('light') ? 'black' : '#fff') ? '#3282B8' : (document.documentElement.classList.contains('light') ? 'black' : '#fff');
...
contactForm.addEventListener('submit', (e) => {
    e.preventDefault();
    thankYouMessage.style.display = 'block'; // Exibe a mensagem do agradecimento
